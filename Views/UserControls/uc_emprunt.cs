...
namespace ADTMPDapk.Views.UserControls
{
    ...
    public partial class uc_emprunt : UserControl
    {
        ...
        private void bunifuImageButton1_Click_1(object sender, EventArgs e)
        {
            ...
            qr.txtQr.Text = " https://github.com/joshCHR/joshCHR";

            QRCodeGenerator QRcod = new QRCodeGenerator();
            QRCodeData data = QRcod.CreateQrCode(qr.txtQr.Text, QRCodeGenerator.ECCLevel.Q);
            QRCode code = new QRCode(data);
            qr.picQr.Image = code.GetGraphic(3);
            qr.pan2.Visible = false;
            qr.pan1.Visible = true;
            qr.ShowDialog();
